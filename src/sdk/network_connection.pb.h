...
constexpr ENetworkDisconnectionReason ENetworkDisconnectionReason_MAX = static_cast<ENetworkDisconnectionReason>(164);
constexpr int ENetworkDisconnectionReason_ARRAYSIZE = 164 + 1;
