...
static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_network_5fconnection_2eproto(&descriptor_table_network_5fconnection_2eproto);
...
PROTOBUF_CONSTINIT const uint32_t ENetworkDisconnectionReason_internal_data_[] = {
    4587520u, 96u, 65278u, 4227858432u, 2147483647u, };
bool ENetworkDisconnectionReason_IsValid(int value) {
  return ::_pbi::ValidateEnum(value, ENetworkDisconnectionReason_internal_data_);
}
